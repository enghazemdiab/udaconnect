...
class PersonServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPersonById = channel.unary_unary(
                ...
                request_serializer=person__pb2.PersonIdRequest.SerializeToString,
...
def add_PersonServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetPersonById': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=person__pb2.PersonIdRequest.FromString,
...
class PersonService(object):
    ...
    def GetPersonById(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/person.PersonService/GetPersonById',
            person__pb2.PersonIdRequest.SerializeToString,
